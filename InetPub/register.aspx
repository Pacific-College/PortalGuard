<%@ Page Language="C#" Inherits="System.Web.UI.Page" %>
  <%@ Assembly Name="PG.NET, Version=1.2.0.0, Culture=neutral, PublicKeyToken=d2cafef75499a122" %>
          ...
          if (!String.IsNullOrEmpty(Request.QueryString["token"])) {
            ...
            if (0 == PortalGuard.Utilities.getRegistration(Request.QueryString["token"], ref prereg, ref m_error)) {
              ...
              foreach(string key in prereg.Keys) {
                // Using HttpUtility.JavaScriptStringEncode and properly formatting the JSON
                string encodedKey = HttpUtility.JavaScriptStringEncode(key);
                string encodedValue = HttpUtility.JavaScriptStringEncode(prereg[key]);
                if (!isFirst) {
                  m_jsonfields += ",";
                }
                m_jsonfields += String.Format("\"{0}\":\"{1}\"", encodedKey, encodedValue);
                isFirst = false;
              }
              m_jsonfields += "}";
            } else {
    ...
    <head>
        ...
        function window_onload() {
          ...
          if (undefined !== allfields.randtoken) {
            ...
            Object.keys(allfields).forEach(function (key) {
              ...
              if (key == "campus" && allfields[key] == "eLearning") allfields[key] = "Online";
              if (null != el) {
      ...
      <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@600&family=Work+Sans:wght@300&display=swap"
        rel="stylesheet" type="text/css">
    </head>

    <body style="font-family:'Work Sans',sans-serif!important;" onload="return window_onload()">
      <div class="container hcenter">
        <div class="row">
          <div class="displaybox col-md-8 col-md-offset-2 shadow register" style="padding: 30px;">
            <div class="row" style="max-width: 720px; margin: auto">
              <div class="col-xs-12 displaybox">
                <img style="width:300px;margin:auto;display:block;"
                  src="https://www.pacificcollege.edu/wp-content/uploads/2022/02/logo_Information_Technology.png">
              </div>
            </div>
            <div class="row dlghdr">
              <div class="col-md-12">
                <div class="text-center">
                  <h1 style="font-family:'Oswald',sans-serif;letter-spacing:3px;color:#003B5C;" id="lblRegisterTitle">
                  </h1>
                </div>
              </div>
            </div>

            <form id="RegisterForm" action="" name="RegisterForm" method="post" autocomplete="off"
              class="form-horizontal">
              <div class="paddedContainer">
                <span id="LangSel" class="clsLangSelector" style="display:none">
                  <label id="lblLangSel" for="listLangSel">Language:</label>
                  <select name="listLangSel" id="listLangSel"></select><input type="button" id="btnChangeLang"
                    onclick="changeLang(document.getElementById('listLangSel'))" value="Change">
                </span>
                ...
                <div id="fldsRegister">
                  ...
                  <div id="fldTOU" class="form-group">
                    <div class="col-md-12">
                      <!--p><span style="font-weight:bold;" id="lblTOU"></span></p-->
                      <div>
                        <p>By completing this form and creating a Pacific College of Health and Science student account,
                          you are agreeing to:</p>
                        <ul>
                          <li>All PCHS policies involving terms of use, acceptable use, network use, and all other
                            applicable policies.</li>
                          <li>All local, state, and federal laws involving the use of computers/ information systems.
                          </li>
                        </ul>
                        <p>To read more about PCHS acceptable use policy, <a
                            href="https://pacificcollege0.sharepoint.com/:b:/s/cybersecurity/ESDK8GlKFJ9Aqh5x3EGnmFcB_nfmlbvHxGcpqAD6RoukUQ?e=t7MJix"
                      ...
                      <span id="fldAcceptTOU">
                        <input type="checkbox" id="acceptTOU" name="acceptTOU" value="1"
                          onclick="document.getElementById('fldAcceptTOU').className = ''" />
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="row containerPGButton">
                        <div class="col-md-12">
                          <button class="PGButton btn" id="btnRegContinue"
                            onclick="submitSelfReg(); return false;">Continue</button>
                        </div>
                        <!-- div class="col-md-6">
